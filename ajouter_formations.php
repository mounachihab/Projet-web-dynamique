...
if (isset($_POST['formation_form_submit'])) {
    $ecole = mysqli_real_escape_string($db_handle, $_POST['ecole']);
    ...
    $sql = "INSERT INTO formations (ID, ecole, competence, domaine, dateDebut, dateFin) VALUES ('$id', '$ecole', '$competence', '$domaine', '$dateDebut', '$dateFin')";
    $result = mysqli_query($db_handle, $sql);
    ...
    if ($result) {
        ...
        echo "Erreur lors de l'ajout de la formation : " . mysqli_error($db_handle);
